...
#Preview("Standard Style") {
    VStack(alignment: .leading, spacing: 16) {
        ...
        HStack(spacing: 20) {
            RadioButtonView(isSelected: .constant(false))
            RadioButtonView(isSelected: .constant(true))
            RadioButtonView(isSelected: .constant(false), isEnabled: false)
        }
    }
    .padding()
}
...
#Preview("Filled Style") {
    VStack(alignment: .leading, spacing: 16) {
        ...
        HStack(spacing: 20) {
            RadioButtonView(isSelected: .constant(false), style: .filled)
            RadioButtonView(isSelected: .constant(true), style: .filled)
            RadioButtonView(isSelected: .constant(false), style: .filled, isEnabled: false)
        }
    }
    .padding()
}
...
#Preview("Minimal Style") {
    VStack(alignment: .leading, spacing: 16) {
        ...
        HStack(spacing: 20) {
            RadioButtonView(isSelected: .constant(false), style: .minimal)
            RadioButtonView(isSelected: .constant(true), style: .minimal)
        }
    }
    .padding()
}
...
#Preview("Bordered Style") {
    VStack(alignment: .leading, spacing: 16) {
        ...
        HStack(spacing: 20) {
            RadioButtonView(isSelected: .constant(false), style: .bordered)
            RadioButtonView(isSelected: .constant(true), style: .bordered)
            RadioButtonView(isSelected: .constant(false), style: .bordered, isEnabled: false)
        }
    }
    .padding()
}
