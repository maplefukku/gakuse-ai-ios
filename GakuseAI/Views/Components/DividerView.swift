...
#Preview("Standard Style") {
    VStack(alignment: .leading, spacing: 20) {
        ...
        DividerView(color: .blue)
        
        DividerView(thickness: 2)
        
        DividerView(horizontalPadding: 0)
    }
    .padding()
}

#Preview("Dashed Style") {
    VStack(alignment: .leading, spacing: 20) {
        Text("Dashed Style")
            .font(.headline)
        
        DividerView(style: .dashed)
        
        DividerView(style: .dashed, color: .green)
        
        DividerView(style: .dashed, thickness: 2)
    }
    .padding()
}

#Preview("Dotted Style") {
    VStack(alignment: .leading, spacing: 20) {
        Text("Dotted Style")
            .font(.headline)
        
        DividerView(style: .dotted)
        
        DividerView(style: .dotted, color: .orange)
        
        DividerView(style: .dotted, thickness: 3)
    }
    .padding()
}
...
#Preview("Minimal Style") {
    VStack(alignment: .leading, spacing: 20) {
        ...
        DividerView(style: .minimal)
        
        DividerView(style: .minimal, horizontalPadding: 24)
    }
    .padding()
}
...
#Preview("Section Divider") {
    VStack(alignment: .leading, spacing: 20) {
        ...
        SectionDividerView(title: "セクション1")
        
        Text("Content 1")
            .font(.body)
        
        SectionDividerView(title: "セクション2", color: .blue)
