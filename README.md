...
- 公開/非公開設定
- ソート機能（新しい順、古い順、タイトル順、カテゴリ順）
- お気に入り機能
- 検索オプション（日付範囲、スキル検索）
- データエクスポート（CSV形式、JSON形式）

#### 統計ビュー
- 週間学習ログチャート
- カテゴリ別分析（円グラフ）
- 統計概要（学習ログ数、スキル数、継続日数）
- ロケール設定対応（日本語・英語）
- インタラクティブチャート（長押しで詳細表示）
...
#### 設定
- プロフィール編集（名前、メールアドレス、アバターアイコン）
- テーマ切り替え（ライト/ダーク/システム、ピンク/ブルー/グリーン/オレンジ）
- 通知設定
- 言語設定（日本語/英語）
- 自動保存設定
- データエクスポート（CSV形式、JSON形式）
